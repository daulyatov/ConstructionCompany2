# Generated by Django 4.2.7 on 2024-05-24 19:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, choices=[('contract', 'Договорной отдел'), ('distribution', 'Отдел распределения'), ('work', 'Рабочий отдел')], max_length=20, null=True, verbose_name='Отдел')),
